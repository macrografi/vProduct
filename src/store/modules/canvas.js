...
const mutations = {
  ...
  INITIALIZE_SCENE(state) {
    ...
    state.scene.fog = new FogExp2(0xffffff, 0.002);

    //var geometry = new CylinderBufferGeometry(0, 30, 30, 4, 1);
    //var geometry = new CircleGeometry(10, 32);
    var geometry = new SphereGeometry(5, 18, 18);
